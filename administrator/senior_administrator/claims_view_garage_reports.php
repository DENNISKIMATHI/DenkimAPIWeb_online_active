        ...
        )
{
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/claims_view_garage_reports.php');
                      ...
                      if($repair_garage_email==$repair_garage_email_is)
                      {
                            ...
                            $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                          <td>'.($count+1).'</td>  
                                                                          ...
                                                                          <td id="view_td'.$count.'" ><a href="'.$claims_view_garage_reports_specific_link.'" title="View full cost sheet by '.$repair_garage_full_names_is.'">View</a></td> 
                                                          </tr>';
