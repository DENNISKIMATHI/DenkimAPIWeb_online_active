...
if(isset($_GET['e']) && !empty($_GET['e']) && isset($_GET['f']) && !empty($_GET['f']) && isset($_GET['p']) && !empty($_GET['p']))
{
                ...
                //fetch
                $returned_json_decoded= fetch_policy_type(5,'/senior_administrator/select_user_performance_bond_insurance.php');
                ...
                if($check_is==true)//if check is true
                {
                                     ...
                                     $count=$skip;//make count skipped rows
                                      ...
                                      {//start of foreach $message_is as $value
                                            ...
                                            $list_items.='<li><a href="select_policy_user_performance_bond_insurance.php?pn='.$policy_number.'&e='.$email_address.'&f='.$full_names.'&p='.$phone_number.'" title="click to view '.$company_name.' performance bond insurance">'.strtoupper($company_name).'</a><br><br></li>';
