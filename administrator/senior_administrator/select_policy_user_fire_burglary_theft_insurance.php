...
{   
	...
	$action_page='select_policy_user_fire_burglary_theft_insurance.php?pn='.$policy_number.'&e='.$email_address.'&f='.$full_names.'&p='.$phone_number;
	 //fetch
        $returned_json_decoded= fetch_policy_type_specific($type_is,$policy_number,'/senior_administrator/select_policy_user_fire_burglary_theft_insurance.php');
        ...
        if( (isset($_POST['fire_price']) && !empty($_POST['fire_price']) ) || (isset($_POST['burglary_price']) && !empty($_POST['burglary_price']) ) || (isset($_POST['all_risk_price']) && !empty($_POST['all_risk_price']) ) )
        {
           ...
           $array_kart=array();
            $array_kart[$type_is][0]=array($item_id=>$items_array_is);
             ...
             check_out_kart_with_email($array_kart,$email_address,'/senior_administrator/select_policy_user_fire_burglary_theft_insurance.php');
            
           
            header('location: view_user_fire_burglary_theft_insurance.php?message=Policy selected&e='.$email_address.'&f='.$full_names.'&type=1&p='.$phone_number.'');//
        }
...
<body class="theme-orange">
    ...
    <section class="content">
        ...
        <form action="<?php echo $action_page;?>" method="post">
            ...
            <h2>All risk( covers electronics and portable gadgets) Formula</h2>
