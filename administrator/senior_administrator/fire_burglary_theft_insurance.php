...
{  
    ...
    $logo_url=trim($_POST['logo_url']);
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/fire_burglary_theft_insurance.php');
...
//fetch
$returned_json_decoded= fetch_policy_type(6,'/senior_administrator/fire_burglary_theft_insurance.php');
...
//get privacy items
$policy_privacy_array=fetch_policy_privacy('6','/senior_administrator/fire_burglary_theft_insurance.php');
$policy_currency_array=fetch_policy_currency('6','/senior_administrator/motor_insurance.php');
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                          <td>'.($count+1).'</td>  
                                                                          ...
                                                                          <td id="privacy_td'.$count.'" >'.$is_private_status.' [<a href="policy_change_privacy.php?s=6&st='.$is_private_status.'&pn='.$policy_number.'&rp=fire_burglary_theft_insurance.php" >'.$is_private_status_make.'</a>]</td>
                                                                          <td id="currency_td'.$count.'" ><select id="'.md5($policy_number).'" onchange="submit_me_as_currency(\'6\',\''.$policy_number.'\',\''.md5($policy_number).'\',\'fire_burglary_theft_insurance.php\');">'.get_select_list_of_currency($policy_currency_array['message'],$policy_number,$currency_lists).'</select></td>
