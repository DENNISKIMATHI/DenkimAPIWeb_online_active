...
$source='/senior_administrator/messages.php';
                                ...
                                {//start of foreach $message_is as $value
                                   ...
                                   $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                                 <td>'.($count+1).'</td>  
                                                                                 ...
                                                                                 <td id="delete_td'.$count.'" ><span id="red_text_span"><a href="'.$delete_link.'" title="Delete all messages between '.strtoupper($recipient_name).' and you">Delete</a></span></td>   
