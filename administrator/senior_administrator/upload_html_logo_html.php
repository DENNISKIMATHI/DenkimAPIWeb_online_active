...
//fetch
$url_is=the_api_authentication_api_url_is()."denkimAPIFiles/MainPackages.ListInsurancePolicyHTMLs";

$myvars='session_key='.$_SESSION['session_key'];

$header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/upload_html_logo_html.php');
...
if($check_is==true)//if check is true
{
    ...
    $action_page='upload_html_logo_html.php?holder=null';
                                 ...
                                 $value=$message_is[$count];
                                   ...
                                   $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                                 <td>'.($count+1).'</td>  
                                                                                 ...
                                                                                 <td id="link_td'.$count.'" ><p title="Click to copy link." style="cursor: pointer;" onclick="myFunction(\''.$id.'\');" >LINK</p><input type="text" value="'.$link.'" id="'.$id.'" /></td>   
...
if(!empty($name))
{
    ...
    //send
    $url_is=the_api_authentication_files_url_is()."denkimAPIFiles/MainPackages.UploadInsurancePolicyHTML?session_key=".$_SESSION['session_key'];
    ...
    if($check_is==true)//if check is true
    {
            ...
            rmdir($location);  
            header('location: upload_html_logo_html.php?message='.$message_is.': '.$file.'&type=1');//
    }
    else//else failed
    {
            //remove file
            unlink($location.$name);
            rmdir($location);
            header('location: upload_html_logo_html.php?message='.$message_is.'&type=2');//
    } 
}
?>
<html>
...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
         <title>Upload policy html</title>
    <!-- Favicon-->
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                       ...
                       <h2><li><a href="upload_html_logo.php" title="Upload policy logo">UPLOAD POLICY LOGO</a>&nbsp;&nbsp;&nbsp;</li><li>UPLOAD POLICY HTML</li><li><a href="upload_html_logo_zip.php" title="Upload Zip">UPLOAD POLICY ZIP</a></li></h2>
