...
isset($_POST['premium_percentage']) && !empty($_POST['premium_percentage']) &&
isset($_POST['excess_protector_percentage']) && !empty($_POST['excess_protector_percentage']) &&
isset($_POST['political_risk_terrorism_percentage']) && !empty($_POST['political_risk_terrorism_percentage']) &&
isset($_POST['aa_membership']) && !empty($_POST['aa_membership']) &&
...
{  
    ...
    $premium_percentage=trim($_POST['premium_percentage']);
    ...
    $logo_url=trim($_POST['logo_url']);
        ...
        $url_is=the_api_authentication_api_url_is()."denkimAPILogic/MainPackages.PolicyCreateMotorInsurance";

        $myvars='session_key='.$_SESSION['session_key'].'&company_name='.$company_name.'&premium_percentage='.$premium_percentage.'&excess_protector_percentage='.$excess_protector_percentage.'&political_risk_terrorism_percentage='.$political_risk_terrorism_percentage.'&aa_membership='.$aa_membership.'&policy_number='.$policy_number.'&expiry_duration_days='.$expiry_duration_days.'&html_url='.$html_url.'&logo_url='.$logo_url;

        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/motor_insurance.php');
        ...
        if($check_is==true)//if check is true
        {
              ...
              header('location: motor_insurance.php?message='.$message_is.'&type=1');//
        }
        else//else failed
        {
...
//fetch
$returned_json_decoded= fetch_policy_type(1,'/senior_administrator/motor_insurance.php');
...
//get privacy items
$policy_privacy_array=fetch_policy_privacy('1','/senior_administrator/motor_insurance.php');
$policy_currency_array=fetch_policy_currency('1','/senior_administrator/motor_insurance.php');
...
//echo json_encode($currency_lists);
...
if($check_is==true)//if check is true
{
                     ...
                     $count=$skip;//make count skipped rows
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            $excess_protector_percentage=$value['excess_protector_percentage'];
                            $political_risk_terrorism_percentage=$value['political_risk_terrorism_percentage '];
                            $aa_membership=$value['aa_membership'];
                            ...
                            $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                          <td>'.($count+1).'</td>  
                                                                          ...
                                                                          <td id="premium_percentage_td'.$count.'" >'.$premium_percentage.'</td>
                                                                          <td id="excess_protector_percentage_td'.$count.'" >'.$excess_protector_percentage.'</td>  
                                                                          <td id="political_risk_terrorism_percentage_td'.$count.'" >'.$political_risk_terrorism_percentage.'</td> 
                                                                          <td id="aa_membership_td'.$count.'" >'.$aa_membership.'</td>
                                                                          ...
                                                                          <td id="privacy_td'.$count.'" >'.$is_private_status.' [<a href="policy_change_privacy.php?s=1&st='.$is_private_status.'&pn='.$policy_number.'&rp=motor_insurance.php" >'.$is_private_status_make.'</a>]</td> 
                                                                          <td id="currency_td'.$count.'" ><select id="'.md5($policy_number).'" onchange="submit_me_as_currency(\'1\',\''.$policy_number.'\',\''.md5($policy_number).'\',\'motor_insurance.php\');">'.get_select_list_of_currency($policy_currency_array['message'],$policy_number,$currency_lists).'</select></td>
                                                                          <td id="delete_td'.$count.'" ><span id="red_text_span"><a href="policy_delete_type_specific.php?p='.$policy_number.'&t=1&s=motor_insurance.php" title="Remove '.$policy_number.'">Delete</a></span></td>   
                                                        </tr>';
                      ...
                      $table_head='<tr bgcolor="white">
                                   <th>#</th>
                                      ...
                                      <th><a href="#"onmouseover="hover_link(\'premium_percentage_td\',\''.$count.'\');" onmouseout="out_link(\'premium_percentage_td\',\''.$count.'\');" >Premium percentage</a></th>
                                       <th><a href="#" onmouseover="hover_link(\'excess_protector_percentage_td\',\''.$count.'\');" onmouseout="out_link(\'excess_protector_percentage_td\',\''.$count.'\');" >Excess protector</a></th>
                                      <th><a href="#" onmouseover="hover_link(\'political_risk_terrorism_percentage_td\',\''.$count.'\');" onmouseout="out_link(\'political_risk_terrorism_percentage_td\',\''.$count.'\');" >Political risk</a></th>
                                      <th><a href="#" onmouseover="hover_link(\'aa_membership_td\',\''.$count.'\');" onmouseout="out_link(\'aa_membership_td\',\''.$count.'\');" >AA membership</a></th>
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <form action="" method="POST">
            ...
            <input type="text" name="premium_percentage" placeholder="Premium percentage"/>
            <input type="text" name="excess_protector_percentage"  placeholder="Excess protector percentage"/>
            <input type="text" name="political_risk_terrorism_percentage"  placeholder="Political risk terrorism percentage"/>
            <input type="number" name="aa_membership"  placeholder="AA membership"/>
