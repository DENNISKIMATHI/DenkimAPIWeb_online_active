...
//fetch
$returned_json_decoded= fetch_policy_type(11,'/senior_administrator/out_patient_medical_insurance.php');
...
//get privacy items
$policy_privacy_array=fetch_policy_privacy('11','/senior_administrator/out_patient_medical_insurance.php');
$policy_currency_array=fetch_policy_currency('11','/senior_administrator/motor_insurance.php');
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                          <td>'.($count+1).'</td>  
                                                                          ...
                                                                          <td id="privacy_td'.$count.'" >'.$is_private_status.' [<a href="policy_change_privacy.php?s=11&st='.$is_private_status.'&pn='.$policy_number.'&rp=out_patient_medical_insurance.php" >'.$is_private_status_make.'</a>]</td>
                                                                          <td id="currency_td'.$count.'" ><select id="'.md5($policy_number).'" onchange="submit_me_as_currency(\'11\',\''.$policy_number.'\',\''.md5($policy_number).'\',\'out_patient_medical_insurance.php\');">'.get_select_list_of_currency($policy_currency_array['message'],$policy_number,$currency_lists).'</select></td>
