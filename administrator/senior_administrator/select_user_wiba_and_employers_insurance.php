...
if(isset($_GET['e']) && !empty($_GET['e']) && isset($_GET['f']) && !empty($_GET['f']) && isset($_GET['p']) && !empty($_GET['p']))
{
                ...
                //fetch
            $returned_json_decoded= fetch_policy_type(16,'/senior_administrator/select_user_wiba_and_employers_insurance.php');
            ...
            if($check_is==true)//if check is true
            {
                            ...
                            $policy_number=$value['policy_number'];
                                        ...
                                        $list_items.='<li><a href="select_policy_user_wiba_and_employers_insurance.php?pn='.$policy_number.'&e='.$email_address.'&f='.$full_names.'&p='.$phone_number.'" title="click to view '.$company_name.' motor insurance ">'.strtoupper($company_name).'</a><br><br></li>';
