        ...
        )
{
                ...
                $statement='Are you sure you want to delete '.strtoupper($mode_of_payment_is).' "'.strtoupper($transaction_code_is).'" KES. '.number_format($amount_paid_is).' ? <span id="red_text_span"><a href="'.$action_page.'&a=yes">[YES]</a></span>  &nbsp;&nbsp;&nbsp;&nbsp;  <span id="green_text_span"><a href="'.$return_link.'">[NO]</a></span> ';
                ...
                if(isset($_GET['a']) && !empty($_GET['a']) )
                {
                    ...
                    {
                        //delete
                                    $url_is=the_api_authentication_api_url_is()."denkimAPILogic/MainPackages.FetchDeletePayment";

                                    $myvars='session_key='.$_SESSION['session_key'].'&email_address='.$email_address.'&_id='.$_id_is;

                                     $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/policy_view_payments_specific_delete.php');
...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
         <title>Policy payments specific delete</title>
    <!-- Favicon-->
