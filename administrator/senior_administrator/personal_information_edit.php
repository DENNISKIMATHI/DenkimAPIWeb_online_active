...
if(isset($_GET['message']) && !empty($_GET['message']) && isset($_GET['type']) && !empty($_GET['type']))
{
    ...
    $url_is=the_api_authentication_api_url_is()."denkimAPILogic/MainPackages.AdministratorFetchDetails";
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/personal_information.php');
        ...
        if(isset($_POST['full_names']) && !empty($_POST['full_names']) && isset($_POST['national_id']) && !empty($_POST['national_id']) & isset($_POST['phone_number']) && !empty($_POST['phone_number']))
        {
            ...
            $phone_number=trim($_POST['phone_number']);
             ...
             $url_is=the_api_authentication_api_url_is()."denkimAPILogic/MainPackages.AdministratorFetchDetailsEdit";
                ...
                $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/personal_information_edit.php');
    ...
    <section class="content">
        <div class="container-fluid">
         ...
         <form action="" method="POST">
             <input type="text" name="full_names" placeholder="Full names" value="<?php echo $full_names_is;?>"/><br>
             <input type="number" name="phone_number"  placeholder="254722333444" value="<?php echo $phone_number_is;?>"/><br>
             <input type="number" name="national_id" placeholder="112233" value="<?php echo $national_id_is;?>"/><br>
