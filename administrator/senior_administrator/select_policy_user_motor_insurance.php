...
{   
        ...
        $action_page='select_policy_user_motor_insurance.php?pn='.$policy_number.'&e='.$email_address.'&f='.$full_names.'&p='.$phone_number;
	 //fetch
        $returned_json_decoded= fetch_policy_type_specific($type_is,$policy_number,'/senior_administrator/select_policy_user_motor_insurance.php');
        ...
        if(isset($_POST['insured_item_value']) && !empty($_POST['insured_item_value']) )
        {
            ...
            $array_kart[$type_is][0]=array($item_id=>$items_array_is);
             ...
             check_out_kart_with_email($array_kart,$email_address,'/senior_administrator/select_policy_user_motor_insurance.php');
            
           
            header('location: view_user_motor_insurance.php?message=Policy selected&e='.$email_address.'&f='.$full_names.'&type=1&p='.$phone_number.'');//
    ...
    <section class="content">
        ...
        <form action="<?php echo $action_page;?>" method="post">
            ...
            <span id="premium_span"></span>
               ...
               <div class="switch">
                Excess protector: <label><input type="checkbox" excess_protector_percentage_is="<?php echo $excess_protector_percentage;?>" status_is="unchecked" name="excess_protector_percentage_is" id="excess_protector_percentage_is" value="1"><span class="lever"></span></label><span id="excess_protector_percentage_is_span"></span><br><br>
