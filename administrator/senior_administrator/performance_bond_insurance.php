...
//get privacy items
$policy_privacy_array=fetch_policy_privacy('5','/senior_administrator/performance_bond_insurance.php');
$policy_currency_array=fetch_policy_currency('5','/senior_administrator/motor_insurance.php');
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                          <td>'.($count+1).'</td>  
                                                                          ...
                                                                          <td id="privacy_td'.$count.'" >'.$is_private_status.' [<a href="policy_change_privacy.php?s=5&st='.$is_private_status.'&pn='.$policy_number.'&rp=performance_bond_insurance.php" >'.$is_private_status_make.'</a>]</td>
                                                                          <td id="currency_td'.$count.'" ><select id="'.md5($policy_number).'" onchange="submit_me_as_currency(\'5\',\''.$policy_number.'\',\''.md5($policy_number).'\',\'performance_bond_insurance.php\');">'.get_select_list_of_currency($policy_currency_array['message'],$policy_number,$currency_lists).'</select></td>
