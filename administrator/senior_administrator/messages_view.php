...
if( isset($_GET['l']) && is_numeric($_GET['l']) && ( $_GET['s']==0 || is_numeric($_GET['s']) ) && isset($_GET['re']) && !empty($_GET['re']) && isset($_GET['fn']) && !empty($_GET['fn']))
{
        ...
        $source='/senior_administrator/messages_view.php';
                    ...
                    $list.='<li id="'.$me_or_Other_id.'">
                            ...
                            <attachment_item>'.$attachment_is.'</attachment_item><br> <br>
                                <date_item>'.return_date_function($time_stamp).'</date_item><br> 
                                    <span id="red_text_span"><a href="'.$delete_link.'&_id='.$_id.'&h='.$header.'" title="Delete '.strtoupper($header).'">Delete</a></span><br>
                            </li>';
            }
