...
//fetch
$url_is=the_api_authentication_api_url_is()."denkimAPIFiles/MainPackages.ListInsurancePolicyZip";

$myvars='session_key='.$_SESSION['session_key'];

$header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/upload_html_logo_zip.php');
...
if($check_is==true)//if check is true
{
    ...
    $action_page='upload_html_logo_zip.php?holder=null';
...
if(!empty($name))
{
    ...
    //send
    $url_is=the_api_authentication_files_url_is()."denkimAPIFiles/MainPackages.UploadInsurancePolicyZip?session_key=".$_SESSION['session_key'];
    ...
    if($check_is==true)//if check is true
    {
            ...
            rmdir($location);  
            header('location: upload_html_logo_zip.php?message='.$message_is.': '.$file.'&type=1');//
    }
    else//else failed
    {
            ...
            unlink($location.$name);
            rmdir($location);
            header('location: upload_html_logo_zip.php?message='.$message_is.'&type=2');//
    } 
}
?>
<html>
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                       ...
                       <h2><li><a href="upload_html_logo.php" title="Upload policy logo">UPLOAD POLICY LOGO</a>&nbsp;&nbsp;&nbsp;<li><a href="upload_html_logo_html.php" title="Upload HTML">UPLOAD POLICY HTML</a></li><li>UPLOAD POLICY ZIP</li></h2>
