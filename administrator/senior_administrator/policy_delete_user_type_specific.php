	...
	$policy_id=trim($_GET['_id']);
        ...
        if(isset($_GET['a']) && !empty($_GET['a']) )
        {
            ...
            if($answer=="yes")
            {
                            ...
                            $url_is=the_api_authentication_api_url_is()."denkimAPILogic/MainPackages.PolicyUserDeleteTypeSpecific";

                            $myvars='session_key='.$_SESSION['session_key'].'&_id='.$policy_id;

                             $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/policy_delete_user_type_specific.php');
                            ...
                            if($check_is==true)//if check is true
                            {
                                  ...
                                  header('location: '.$source_link.'&message='.$message_is.'&type=1');//
                            }
                            else//else failed
                            {

                                header('location: '.$source_link.'&message='.$message_is.'&type=2');//
                            } 
...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
         <title>Policy Delete User Policy Type Specific</title>
    <!-- Favicon-->
    ...
    <section class="content">
        <div class="container-fluid">
           ...
           <?php echo $statement;?>
            ...
            <!-- #END# CPU Usage --> <a href="../senior_administrator/" title="Go to the main page" class="btn btn-primary m-t-15 waves-effect"> <i class="material-icons">arrow_back</i>Back </a><br><br> 
            </div>
        </div>
    </section>
