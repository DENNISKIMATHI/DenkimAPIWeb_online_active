...
isset($_POST['v_percentage']) && !empty($_POST['v_percentage']) &&
isset($_POST['n_percentage']) && !empty($_POST['n_percentage']) &&
isset($_POST['minimum_excess_protector']) && !empty($_POST['minimum_excess_protector']) &&
isset($_POST['minimum_political_violence']) && !empty($_POST['minimum_political_violence']) &&
isset($_POST['excess_protector_multiplier']) && !empty($_POST['excess_protector_multiplier']) &&
isset($_POST['political_violence_multiplier']) && !empty($_POST['political_violence_multiplier']) &&
isset($_POST['aa_constant']) && !empty($_POST['aa_constant']) &&
...
{  
    ...
    $v_percentage=trim($_POST['v_percentage']);
    $n_percentage=trim($_POST['n_percentage']);
    $minimum_excess_protector=trim($_POST['minimum_excess_protector']);
    $minimum_political_violence=trim($_POST['minimum_political_violence']);
    $excess_protector_multiplier=trim($_POST['excess_protector_multiplier']);
    $political_violence_multiplier=trim($_POST['political_violence_multiplier']);
    $aa_constant=trim($_POST['aa_constant']);
    ...
    $logo_url=trim($_POST['logo_url']);
        ...
        $url_is=the_api_authentication_api_url_is()."denkimAPILogic/MainPackages.PolicyCreateMotorPsvUberTaxiInsurance";
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/motor_psv_uber_insurance.php');
        ...
        if($check_is==true)//if check is true
        {
              ...
              header('location: motor_psv_uber_insurance.php?message='.$message_is.'&type=1');//
        }
        else//else failed
        {

            header('location: motor_psv_uber_insurance.php?message='.$message_is.'&type=2');//
        } 
...
//fetch
$returned_json_decoded= fetch_policy_type(15,'/senior_administrator/motor_psv_uber_insurance.php');
...
//get privacy items
$policy_privacy_array=fetch_policy_privacy('15','/senior_administrator/motor_psv_uber_insurance.php');
$policy_currency_array=fetch_policy_currency('15','/senior_administrator/motor_insurance.php');
...
{ 
                     ...
                     $count=$skip;//make count skipped rows
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            $v_percentage=$value['v_percentage'];
                            $n_percentage=$value['n_percentage'];
                            $minimum_excess_protector=$value['minimum_excess_protector'];
                            $minimum_political_violence=$value['minimum_political_violence'];
                            $excess_protector_multiplier=$value['excess_protector_multiplier'];
                            $political_violence_multiplier=$value['political_violence_multiplier'];
                            $aa_constant=$value['aa_constant'];
                            ...
                            $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                          <td>'.($count+1).'</td>  
                                                                          ...
                                                                          <td id="v_percentage_td'.$count.'" >'.$v_percentage.'</td>
                                                                          <td id="n_percentage_td'.$count.'" >'.$n_percentage.'</td>  
                                                                          <td id="minimum_excess_protector_td'.$count.'" >'.number_format($minimum_excess_protector,2).'</td>  
                                                                          <td id="minimum_political_violence_td'.$count.'" >'.number_format($minimum_political_violence,2).'</td>  
                                                                          <td id="excess_protector_multiplier_td'.$count.'" >'.$excess_protector_multiplier.'</td>  
                                                                          <td id="political_violence_multiplier_td'.$count.'" >'.$political_violence_multiplier.'</td>
                                                                          <td id="aa_constant_td'.$count.'" >'.number_format($aa_constant,2).'</td>
                                                                          ...
                                                                          <td id="privacy_td'.$count.'" >'.$is_private_status.' [<a href="policy_change_privacy.php?s=15&st='.$is_private_status.'&pn='.$policy_number.'&rp=motor_psv_uber_insurance.php" >'.$is_private_status_make.'</a>]</td>
                                                                          <td id="currency_td'.$count.'" ><select id="'.md5($policy_number).'" onchange="submit_me_as_currency(\'15\',\''.$policy_number.'\',\''.md5($policy_number).'\',\'motor_psv_uber_insurance.php\');">'.get_select_list_of_currency($policy_currency_array['message'],$policy_number,$currency_lists).'</select></td>
                                                                          <td id="delete_td'.$count.'" ><span id="red_text_span"><a href="policy_delete_type_specific.php?p='.$policy_number.'&t=15&s=motor_psv_uber_insurance.php" title="Remove '.$policy_number.'">Delete</a></span></td>   
                                                        </tr>';
                      ...
                      $table_head='<tr bgcolor="white">
                                   <th>#</th>
                                       <th><a href="#"onmouseover="hover_link(\'company_name_td\',\''.$count.'\');" onmouseout="out_link(\'company_name_td\',\''.$count.'\');" >Company name</a></th>
                                        ...
                                        <th><a href="#"onmouseover="hover_link(\'v_percentage_td\',\''.$count.'\');" onmouseout="out_link(\'v_percentage_td\',\''.$count.'\');" >V percentage</a></th>
                                       <th><a href="#" onmouseover="hover_link(\'n_percentage_td\',\''.$count.'\');" onmouseout="out_link(\'n_percentage_td\',\''.$count.'\');" >N percentage</a></th>
                                        <th><a href="#"onmouseover="hover_link(\'minimum_excess_protector_td\',\''.$count.'\');" onmouseout="out_link(\'minimum_excess_protector_td\',\''.$count.'\');" >Minimum excess protector</a></th>
                                       <th><a href="#" onmouseover="hover_link(\'minimum_political_violence_td\',\''.$count.'\');" onmouseout="out_link(\'minimum_political_violence_td\',\''.$count.'\');" >Minimum political violence</a></th>
                                        <th><a href="#"onmouseover="hover_link(\'excess_protector_multiplier_td\',\''.$count.'\');" onmouseout="out_link(\'excess_protector_multiplier_td\',\''.$count.'\');" >Excess protector multiplier</a></th>
                                       <th><a href="#" onmouseover="hover_link(\'political_violence_multiplier_td\',\''.$count.'\');" onmouseout="out_link(\'political_violence_multiplier_td\',\''.$count.'\');" >Political violence multiplier</a></th>
                                        <th><a href="#"onmouseover="hover_link(\'aa_constant_td\',\''.$count.'\');" onmouseout="out_link(\'aa_constant_td\',\''.$count.'\');" >AA constant</a></th>
...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
          <title>Motor/psv/uber insurance</title>
    <!-- Favicon-->
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <form action="" method="POST">
            ...
            <input type="number" name="v_percentage" required step=any placeholder="V percentage"/>
            <input type="number" name="n_percentage" required step=any placeholder="N percentage"/>
            <input type="number" name="minimum_excess_protector" required placeholder="Minimum excess protector"/>
            <input type="number" name="minimum_political_violence" required placeholder="Minimum political violence"/>
            <input type="number" name="excess_protector_multiplier" required step=any placeholder="Excess protector multiplier"/>
            <input type="number" name="political_violence_multiplier" required step=any placeholder="Political violence multiplier"/>
            <input type="number" name="aa_constant" required  placeholder="AA constant"/>
