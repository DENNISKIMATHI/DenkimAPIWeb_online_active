...
{  
    ...
    $logo_url=trim($_POST['logo_url']);
        ...
        $url_is=the_api_authentication_api_url_is()."denkimAPILogic/MainPackages.PolicyCreateDentalInsurance";
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/senior_administrator/dental_insurance.php');
        ...
        if($check_is==true)//if check is true
        {
              ...
              header('location: dental_insurance.php?message='.$message_is.'&type=1');//
        }
        else//else failed
        {

            header('location: dental_insurance.php?message='.$message_is.'&type=2');//
        } 
...
//fetch
$returned_json_decoded= fetch_policy_type(9,'/senior_administrator/dental_insurance.php');
...
$policy_currency_array=fetch_policy_currency('9','/senior_administrator/motor_insurance.php');
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                          <td>'.($count+1).'</td>  
                                                                          ...
                                                                          <td id="options_td'.$count.'" ><a href="#" title="'.make_list_out_of_dental_array($options).'">Options</a></td>
                                                                          ...
                                                                          <td id="currency_td'.$count.'" ><select id="'.md5($policy_number).'" onchange="submit_me_as_currency(\'9\',\''.$policy_number.'\',\''.md5($policy_number).'\',\'dental_insurance.php\');">'.get_select_list_of_currency($policy_currency_array['message'],$policy_number,$currency_lists).'</select></td>
    ...
    <section class="content">
        <div class="container-fluid">
		  ...
		  <?php echo $table;?><br>
                           ...
                           <script type="text/javascript" src="../../javascript/dental_insurance.js"></script>
