        ...
        )
{
        ...
        $full_link="tasks_delete.php?l=".$limit."&s=".$skip."&_id=".$_id."&task=".$task."&reminder_date_time=".$reminder_date_time."&repeats=".$repeats;//for headers sorting
        
        $statement='Are you sure you want to delete '.strtoupper($task).'? <span id="red_text_span"><a href="'.$full_link.'&a=yes">[YES]</a></span>  &nbsp;&nbsp;&nbsp;&nbsp;  <span id="green_text_span"><a href="'.$return_link.'">[NO]</a></span> ';
        ...
        if(isset($_GET['a']) && !empty($_GET['a']) )
        {
            ...
            {
                //delete
                             $url_is=the_api_for_php_is_url_is()."remove_diary/";
