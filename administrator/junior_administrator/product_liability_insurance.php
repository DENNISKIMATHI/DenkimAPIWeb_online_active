...
{  
    ...
    $logo_url=trim($_POST['logo_url']);
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/junior_administrator/public_liability_insurance.php');
...
//fetch
$returned_json_decoded= fetch_policy_type(12,'/junior_administrator/public_liability_insurance.php');
