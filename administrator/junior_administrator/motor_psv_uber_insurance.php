...
{  
    ...
    $logo_url=trim($_POST['logo_url']);
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/junior_administrator/motor_psv_uber_insurance.php');
...
//fetch
$returned_json_decoded= fetch_policy_type(15,'/junior_administrator/motor_psv_uber_insurance.php');
                ...
                <ul class="list">
                   ...
                   <li>
                       <a href="messages.php" title="Send and get messages">
                            ...
                            <span>Messages </span>
                        <?php echo get_inbox_count_function($_SESSION['session_key'],$_SESSION['cookie'],'/junior_administrator/*');?></a>
                    </li>
    ...
    <section class="content">
        <div class="container-fluid">
		   ...
		   <?php echo $table;?><br>
						...
						<script type="text/javascript" src="../../javascript/optical_insurance.js"></script>
