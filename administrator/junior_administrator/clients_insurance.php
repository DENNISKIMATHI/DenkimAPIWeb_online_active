...
<body class="theme-orange">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <h4>In patient medical insurance: <a href="./view_user_in_patient_medical_insurance.php<?php echo $view_argument;?>" title="View and select In patient medical insurance">View</a></h4>
            <h4>Accident insurance: <a href="./view_user_accident_insurance.php<?php echo $view_argument;?>" title="View and select Accident insurance">View</a></h4>
            <h4>Contractors all risk insurance: <a href="./view_user_contractors_all_risk_insurance.php<?php echo $view_argument;?>" title="View and select Contractors all risk insurance">View</a></h4>
            <h4>Performance Bond insurance: <a href="./view_user_performance_bond_insurance.php<?php echo $view_argument;?>" title="View and select Performance Bond insurance">View</a></h4>
            <h4>Fire burglary theft insurance: <a href="./view_user_fire_burglary_theft_insurance.php<?php echo $view_argument;?>" title="View and selectFire burglary theft insurance">View</a></h4>
            <h4>Home insurance: <a href="./view_user_home_insurance.php<?php echo $view_argument;?>" title="View and select Home insurance">View</a></h4>
            <h4>Maternity insurance: <a href="./view_user_maternity_insurance.php<?php echo $view_argument;?>" title="View and select Maternity insurance">View</a></h4>
            <h4>Dental insurance: <a href="./view_user_dental_insurance.php<?php echo $view_argument;?>" title="View and select Dental insurance">View</a></h4> 
            <h4>Optical insurance: <a href="./view_user_optical_insurance.php<?php echo $view_argument;?>" title="View and select Optical insurance">View</a></h4> 
            <h4>Out patient medical insurance: <a href="./view_user_out_patient_medical_insurance.php<?php echo $view_argument;?>" title="View and select Out patient medical insurance">View</a></h4>
