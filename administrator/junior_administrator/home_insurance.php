...
{  
    ...
    $logo_url=trim($_POST['logo_url']);
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/junior_administrator/home_insurance.php');
...
//fetch
$returned_json_decoded= fetch_policy_type(7,'/junior_administrator/home_insurance.php');
