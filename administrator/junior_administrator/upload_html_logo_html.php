...
$header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/junior_administrator/upload_html_logo_html.php');
                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                      <li><a href="upload_html_logo.php" title="Upload policy logo">UPLOAD POLICY LOGO</a>&nbsp;&nbsp;&nbsp;</li><li>UPLOAD POLICY HTML</li><li><a href="upload_html_logo_zip.php" title="Upload Zip">UPLOAD POLICY ZIP</a></li>
