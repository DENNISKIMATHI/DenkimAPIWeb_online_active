...
{  
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/assessor_loss_adjsuter/claims_create_assessor_report.php');
        ...
        if($check_is==true)//if check is true
        {
               //login and send message
                $message_is_is=login_behalf_of_client($email_address,'/assessor_loss_adjsuter/claims_create_assessor_report.php');
                //get client phone number
                $client_info=get_specific_client_details($_SESSION['session_key'],$_SESSION['cookie'],$email_address,'/assessor_loss_adjsuter/claims_create_assessor_report.php');
                ...
                send_sms_message($_SESSION['session_key'],$_SESSION['cookie'],$message_send,$client_info['phone_number'],'/assessor_loss_adjsuter/claims_create_assessor_report.php');
                    //send email
                    $header_email_is="New report for claim number ". strtoupper($claim_number);
                    send_email_message($_SESSION['session_key'],$_SESSION['cookie'],$client_info['email_address'],$header_email_is,$message_send,'/assessor_loss_adjsuter/claims_create_assessor_report.php'); 
