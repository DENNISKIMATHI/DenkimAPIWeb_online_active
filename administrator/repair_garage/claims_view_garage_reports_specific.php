        ...
        )
{
        ...
        $full_link="claims_view_garage_reports_specific.php?l=".$limit."&s=".$skip."&re=".$rows_every."&e=".$email_address."&f=".$full_names."&_id=".$_id."&c_n=".$claim_number."&a_e=".$assessor_email."&r_g_e=".$repair_garage_email."&t_s=".$time_stamp."&a_f_n=".$assessor_full_names."&a_p_n=".$assessor_phone_number."&r_g_f_n=".$repair_garage_full_names.'&r_g_p_n='.$repair_garage_phone_number.'&r_id='.$report_id;//for form submission
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/repair_garage/claims_view_garage_reports_specific.php');
        ...
        if($check_is==true)//if check is true
        {
                ...
                {//start of foreach $message_is as $value
                        ...
                        {//start of if if($_id_is==$report_id)
                            ...
                            $repair_garage_phone_numbe_isr=$value['repair_garage_phone_number'];
...
<head>
  ...
  <title>View Cost sheet specific</title>
    <!-- Favicon-->
