...
$source='/repair_garage/messages.php';
...
$drop_down_list=make_message_drop_down_box($personal_details_array['email_address'],$_SESSION['session_key'],$_SESSION['cookie'],$source,true);//is admin is true
...
if($check_is==true)//if check is true
{
                                ...
                                {//start of foreach $message_is as $value
                                   ...
                                   $delete_link='messages_delete.php?re='.$recipient_email.'&rn='.$recipient_name;
