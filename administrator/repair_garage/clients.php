...
if( isset($_GET['l']) && is_numeric($_GET['l']) && ( $_GET['s']==0 || is_numeric($_GET['s']) ) &&  isset($_GET['sc']) && !empty($_GET['sc']) && isset($_GET['so']) && !empty($_GET['so']) && isset($_GET['re']) && !empty($_GET['re']))
{
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/repair_garage/clients.php');
        ...
        if($check_is==true)//if check is true
        {
            ...
            //get email details and filter
            $details=fetch_personal_details(2,$_SESSION['session_key'],$_SESSION['cookie'],'/repair_garage/clients.php');
            $message_is=filter_clients_for_garage($message_is,$details,'/repair_garage/clients.php');
           ...
           $count=$skip;//make count skipped rows
            ...
            $table_head='<tr bgcolor="white">
                         <th>#</th>
                            ...
                            <th><a href="'.$link_without_sort_column_sort_order.'&sc=time_stamp&so='.return_script_order($sort_column,$sort_order,"time_stamp").'" onmouseover="hover_link(\'claims_td\',\''.$total_for_table_rows.'\');" onmouseout="out_link(\'claims_td\',\''.$total_for_table_rows.'\');" >Claims</a></th>
            ...
            {//start of foreach $message_is as $value
                  ...
                  $table=$table.'<tr class="'.$row_color.'" id="row_data">
                                                <td>'.($count+1).'</td>  
                                                                ...
                                                                <td id="claims_td'.$count.'" ><a href="'.$claims.'&e='.$email_address.'&f='.$full_names.'" title="View and select claims for '.$full_names.'"class="tbutton">View/create report</a></td>   
                ...
                $message='<span id="bad_upload_message">'.$message_is.'</span>';
                    ...
                    {  
                        ...
                        if($antispam==$_SESSION['spam'])
                        {
                            ...
                            $header_array= array('Authorization:'.api_key_is(),'Origin:/repair_garage/clients.php');
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../repair_garage/" title="Go to the main page"><img src="../../images/logo.png" alt="Denkim insurance" height="50" width="200"></a>
             </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                       <a href="../repair_garage/" title="Go to the main page">
                    ...
                    <li>
                       <a href="messages.php" title="Send and get messages">
                            ...
                            <span>Messages </span>
                        <?php echo get_inbox_count_function($_SESSION['session_key'],$_SESSION['cookie'],'/repair_garage/*');?></a>
                    </li>
    ...
    <section class="content">
        <div class="container-fluid">
		 ...
		 <form method="POST" action="<?php echo $full_link;?>" id="browse_form">
			 ...
			 <a href="../repair_garage/" title="Go to the main page" class="btn btn-primary m-t-15 waves-effect"> <i class="material-icons">arrow_back</i>Back </a><br><br> 
            <!-- #END# -->
            </div>
        </div>
    </section>
