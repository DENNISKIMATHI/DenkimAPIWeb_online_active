...
{  
        ...
        $url_is=the_api_authentication_api_url_is()."denkimAPILogic/MainPackages.RepairGarageCreateClaimCostSheet";
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/repair_garage/claims_create_garage_report.php');
        ...
        if($check_is==true)//if check is true
        {
                ...
                $client_info=get_specific_client_details($_SESSION['session_key'],$_SESSION['cookie'],$email_address,'/repair_garage/claims_create_garage_report.php');
                $message_send="Hello ".$full_names.", claim number ".$claim_number." has a new cost sheet in your DENKIM account. Please login with the following link to view. ".$message_is_is;
                //send message to notify on claim
                send_sms_message($_SESSION['session_key'],$_SESSION['cookie'],$message_send,$client_info['phone_number'],'/repair_garage/claims_create_garage_report.php');
                 //send email
                $header_email_is="New cost sheet for claim number ". strtoupper($claim_number);
                send_email_message($_SESSION['session_key'],$_SESSION['cookie'],$client_info['email_address'],$header_email_is,$message_send,'/repair_garage/claims_create_garage_report.php'); 
        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
		     ...
		     <h4>Claim number: <?php echo $claim_number;?></h4> 
                     ...
                     <h4>Assigned Repair garage: <?php echo $repair_garage_full_names."[".$repair_garage_email."/".$repair_garage_phone_number."]";?></h4>  
         ...
         <form action="<?php echo $full_link;?>" method="POST">
           ...
           <script type="text/javascript" src="../../javascript/repair_garage_cost_sheet.js"></script>
