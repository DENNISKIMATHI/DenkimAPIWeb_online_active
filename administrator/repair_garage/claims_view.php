...
if(isset($_GET['l']) && is_numeric($_GET['l']) && ( $_GET['s']==0 || is_numeric($_GET['s']) ) && isset($_GET['re']) && !empty($_GET['re']) && isset($_GET['e']) && !empty($_GET['e']) && isset($_GET['f']) && !empty($_GET['f'])  && !empty($_GET['_id']) && isset($_GET['_id']) )
{
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/repair_garage/claims_view.php');
        ...
        if($check_is==true)//if check is true
        {
                  ...
                  $table='<table class="table table-bordered table-hover table-responsive">
                        ...
                        $count=0;//set count
                                    ...
                                    //append remarks
                                    $table.='<h4>Other claim remarks</h4><br>'.$table_remarks.'<a href="'.$add_remark_link.'" title="Add remark to '.$claim_number.'" class="btn btn-primary m-t-15 waves-effect">Add</a><br>';
                                                                            ...
                                                                            {//start of foreach $message_is as $value
                                                                                  ...
                                                                                  $table_assigned_repair_garages=$table_assigned_repair_garages.'<tr class="'.$row_color.'" id="row_data">
                                                                                                                <td>'.($count+1).'</td>  
                                                                                                                                ...
                                                                                                                                <td id="view_add_cost_sheet_td'.$count.'" ><a href="'.$view_garage_reports.'" title="View and/or add cost sheets for claim number '.$claim_number.'" class="tbutton">View/create cost sheet</a></td>
                                                                                                                </tr>';
