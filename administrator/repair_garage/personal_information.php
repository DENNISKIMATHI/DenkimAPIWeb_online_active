...
if(isset($_GET['message']) && !empty($_GET['message']) && isset($_GET['type']) && !empty($_GET['type']))
{
    ...
    $url_is=the_api_authentication_api_url_is()."denkimAPILogic/MainPackages.AdministratorFetchDetails";
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/repair_garage/personal_information.php');
        ...
        if($check_is==true)//if check is true
        {
            ...
            $insurance_company_is=$returned_json_decoded["insurance_company"];
            $employee_number_is=$returned_json_decoded["employee_number"];
            $kra_pin_is=$returned_json_decoded["kra_pin"];
            $rating_is=$returned_json_decoded["rating"];
            ...
            <div class="row clearfix">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="body">
		    <?php echo $message;?>
         <h4><?php echo $full_names_is;?></h4>
         <h4><?php echo $phone_number_is;?></h4>
         <h4><?php echo $national_id_is;?></h4>
         <h4><?php echo $insurance_company_is;?></h4>
         <h4><?php echo $employee_number_is;?></h4>
         <h4><?php echo $kra_pin_is;?></h4>
         <h4><?php echo $rating_is;?></h4>
