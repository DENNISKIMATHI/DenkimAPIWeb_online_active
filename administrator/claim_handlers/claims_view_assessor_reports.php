        ...
        )
{
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/claim_handlers/claims_view_assessor_reports.php');
    ...
    <section class="content">
        <div class="container-fluid">
		 ...
		 <h4>Claim number:<br><br> <?php echo $claim_number;?><br><br></h4> 
                     <h4>Claim handler:<br><br> <?php echo $claim_handler_full_names."<br>".$claim_handler_email."<br>".$claim_handler_phone_number."<br>";?></h4> 
