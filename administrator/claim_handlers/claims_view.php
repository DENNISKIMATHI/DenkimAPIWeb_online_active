...
if(isset($_GET['l']) && is_numeric($_GET['l']) && ( $_GET['s']==0 || is_numeric($_GET['s']) ) && isset($_GET['re']) && !empty($_GET['re']) && isset($_GET['e']) && !empty($_GET['e']) && isset($_GET['f']) && !empty($_GET['f'])  && !empty($_GET['_id']) && isset($_GET['_id']) )
{
        ...
        $header_array= array('Cookie:'.$_SESSION['cookie'],'Authorization:'.api_key_is(),'Origin:/claim_handlers/claims_view.php');
        ...
        if($check_is==true)//if check is true
        {
                  ...
                  $table='<table class="table table-bordered table-hover table-responsive">
                        ...
                        $count=0;//set count
                                    ...
                                    //append remarks
                                    $table.='<h4>Other claim remarks</h4><br>'.$table_remarks.'<a href="'.$add_remark_link.'" title="Add remark to '.$claim_number.'" class="btn btn-primary m-t-15 waves-effect">Add</a><br><br>';
                        ...
                        $count=0;//set count
                                                         ...
                                                         $view_assessor_reports="claims_view_assessor_reports.php?l=".$limit."&s=".$skip."&re=".$rows_every."&e=".$email_address."&f=".$full_names."&_id=".$_id.'&c_n='.$claim_number."&a_e=".$assessor_email."&c_h_e=".$claim_handler_email."&t_s=".$time_stamp."&a_f_n=".$assessor_full_names."&a_p_n=".$assessor_phone_number."&c_h_f_n=".$claim_handler_full_names.'&c_h_p_n='.$claim_handler_phone_number;//for form submission
                                                          ...
                                                          $table_assigned_assessors=$table_assigned_assessors.'<tr class="'.$row_color.'" id="row_data">
                                                                                        <td>'.($count+1).'</td>  
                                                                                                        ...
                                                                                                        <td id="view_add_report_td'.$count.'" ><a href="'.$view_assessor_reports.'" title="View report by claim number '.$assessor_full_names.'"class="tbutton">View/create report</a></td>
                                                                                        </tr>';
                                    ...
                                    //make add add assessor link 
                                    $add_assessor_link="claims_assign_assessor.php?l=".$limit."&s=".$skip."&re=".$rows_every."&e=".$email_address."&f=".$full_names."&_id=".$_id.'&c_n='.$claim_number;//for form submission
       
                                    //append add assessors
                                    $table.='<h4>Assigned Assessors/Loss adjusters</h4><br>'.$table_assigned_assessors.'<a href="'.$add_assessor_link.'" title="Assign assessor/loss adjuster to '.$claim_number.'" class="btn btn-primary m-t-15 waves-effect">Assign</a><br><br>';
                                    ...
                                    $count=0;//set count
                                                                ...
                                                                {//start of foreach $message_is as $value
                                                                      ...
                                                                      $table_assigned_repair_garages=$table_assigned_repair_garages.'<tr class="'.$row_color.'" id="row_data">
                                                                                                    <td>'.($count+1).'</td>  
                                                                                                                    ...
                                                                                                                    <td id="view_add_cost_sheet_td'.$count.'" ><a href="'.$view_garage_reports.'" title="View cost sheets by '.$repair_garage_full_names.'"class="tbutton">View/create cost sheet</a></td>
                                                                                                    </tr>';
                                                ...
                                                //check if claim has garage report for claim verification
                                                $check_garage_report=check_if_claim_has_garage_report($_id,"/claim_handlers/claims_view.php");
                                                
                                                if($check_garage_report==true)//proceed to fetch and print who have approved
                                                {
                                                    //view claims
                                                    $approve_link="claims_approve_claim.php?l=".$limit."&s=".$skip."&re=".$rows_every."&e=".$email_address."&f=".$full_names."&_id=".$_id.'&c_n='.$claim_number;//for form submission
       
                                                    $message_for_verification='Click <a href="'.$approve_link.'" title="Approve '.$claim_number.'" class="tbutton">here</a> approve claim';
                                                ...
                                                {
                                                    $message_for_verification='No available garage repair cost sheets for you to approve the claim!';
                                                }
        }
        else//else failed
        {
...
<body class="theme-orange">
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <?php echo $table;?><br>
          <?php echo $message_for_verification;?><br>
