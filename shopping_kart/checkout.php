...
<body class="theme-orange">
    ...
    <section class="content">
        <div class="container-fluid">
		    ...
		    <?php echo $message;?><br>
        <?php echo $list;?><br>
        <h2><a href="./checkout_login.php" title="Login with your email address and Denkim will be in contact on how to pay for your policies" class="btn btn-primary m-t-15 waves-effect">Already a member</a></h2> 
        <h2><a href="./checkout_signup.php" title="Sign up with your email address and Denkim will be in contact on how to pay for your policies" class="btn btn-primary m-t-15 waves-effect" >Not a member</a></h2> 
