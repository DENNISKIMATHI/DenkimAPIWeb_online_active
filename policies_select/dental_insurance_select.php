...
{   
        ...
        $action_page='dental_insurance_select.php?pn='.$policy_number;
	 //fetch
        $returned_json_decoded= fetch_policy_type_specific($type_is,$policy_number,'/policies_select/dental_insurance_select.php');
