...
{   
        ...
        $action_page='performance_bond_insurance_select.php?pn='.$policy_number;
	 //fetch
        $returned_json_decoded= fetch_policy_type_specific($type_is,$policy_number,'/policies_select/performance_bond_insurance_select.php');
