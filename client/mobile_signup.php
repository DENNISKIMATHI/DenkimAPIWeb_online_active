	...
	$message='<span id="'.$good_bad_id.'">'.$message.'</span>';
                    ...
                    {  
                        ...
                        if($antispam==$_SESSION['spam'])
                        {
                            ...
                            $header_array= array('Authorization:'.api_key_is(),'Origin:/client/mobile_signup.php');
                            ...
                            if($check_is==true)//if check is true
                            {
                                  ...
                                  header('location: mobile_login.php?message='.$message_is.'&type=1');//
                            }
                            else//else failed
                            {

                                header('location: mobile_signup.php?message='.$message_is.'&type=2');//
                            } 
                        }
                        else
                        {
                             header('location: mobile_signup.php?message=Failed anti-spam test, please try again&type=2');//
		 ...
		 <?php echo $message;?><br>
                <form action="" method="POST">
                    ...
                    <div class="m-t-25 m-b--5 align-center">
                        <a href="mobile_login.php">Home</a>
                    </div>
                </form>
            </div>
        </div>
