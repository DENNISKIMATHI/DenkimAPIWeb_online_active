    ...
    <section class="content">
        <div class="container-fluid">
		  ...
		  <div class="row clearfix">
            ...
            <h4>Enter the value of the vehicle.</h4>
            <input type="number" class="form-control" min="1" name="vehicle_value" required v_percentage="<?php echo $v_percentage;?>" n_percentage="<?php echo $n_percentage;?>"  id="vehicle_value" placeholder="Vehicle value"/>
            <br>
            
            <h4>Enter the number of passengers.</h4>
            <input type="number" class="form-control" min="1" name="number_of_passengers"  id="number_of_passengers"  required v_percentage="<?php echo $v_percentage;?>" n_percentage="<?php echo $n_percentage;?>" placeholder="Number of passengers"/>
            <br>
            
            <h4>Enter the vehicle registration details.</h4>
            <textarea name="vehicle_registration_details" required placeholder="Vehicle registration details" class="form-control"></textarea>
            <br>
