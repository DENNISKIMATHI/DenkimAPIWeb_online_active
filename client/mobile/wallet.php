                         ...
                         ?>
                            <ol>
                                ...
                                <form action="<?php echo $action_page?>&account_number=<?php echo $account_number?>&use_date=<?php echo $use_date?>" method="POST">
                                    ...
                                    Mobile number(2547XXXXXXX)<input type="number" class="form-control" value="<?php echo $_POST['phone_number'];?>" name="phone_number"><br>
                     ...
                     {//if($account_number!=0)
                            ...
                            <ol>
                                ...
                                <form action="<?php echo $action_page?>" method="POST">
                                    Amount<input type="number"  class="form-control"required name="total" min="1" max="70000"><br>
                                    Mobile number(2547XXXXXXX)<input required type="number" class="form-control" value="<?php echo $phone_number;?>" name="phone_number"><br>
                                    Use date starts on<br><input type="date"  class="form-control" value="<?php echo return_date_actual_function( (1000* time()) )?>" name="use_date" required  min="<?php echo return_date_actual_function( (1000* time()) )?>" > <br><br>
