                            ...
                            $count=$skip;//make count skipped rows
                             ...
                             {//start of foreach $message_is as $value
                                   ...
                                   $time_stamp=$value['time_stamp'];
                                        ...
                                        $list_items.='<a href="select_policy_user_in_patient_medical_insurance.php?pn='.$policy_number.'" title="click to view '.$company_name.' in patient medical insurance "class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br>';
