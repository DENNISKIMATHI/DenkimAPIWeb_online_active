...
if(isset($_GET['message']) && !empty($_GET['message']) && isset($_GET['type']) && !empty($_GET['type']))
{
	$message=$_GET['message'];
	 ...
	 $message='<span id="'.$good_bad_id.'">'.$message.'</span>';
                ...
                //fetch
            $returned_json_decoded= fetch_policy_type(14,'/client/console/select_user_product_liability_insurance.php');
            ...
            $message_is=$returned_json_decoded["message"];//message
             ...
             //get privacy items
            $policy_privacy_array=fetch_policy_privacy('14','/client/console/select_user_product_liability_insurance.php');
                                 ...
                                 $list_items='';
                                  ...
                                  {//start of foreach $message_is as $value
                                       $company_name=$value['company_name'];
                                        ...
                                        $list_items.='<a href="select_policy_user_product_liability_insurance.php?pn='.$policy_number.'" title="click to view '.$company_name.' motor insurance " class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br>';
