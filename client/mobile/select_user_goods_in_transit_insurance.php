            ...
            if($check_is==true)//if check is true
            {
                                 ...
                                 $list_items='';
                                  ...
                                  {//start of foreach $message_is as $value
                                        ...
                                        $list_items.='<a href="select_policy_user_goods_in_transit_insurance.php?pn='.$policy_number.'" title="click to view '.$company_name.' motor insurance " class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br>';
