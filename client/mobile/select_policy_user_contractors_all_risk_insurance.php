...
{   
        ...
        //fetch email
        $personal_details_array=fetch_personal_details(3,$_SESSION['session_key'],$_SESSION['cookie'],'/client/console/select_policy_user_contractors_all_risk_insurance.php');
        $email_address=$personal_details_array['email_address'];
        
        $policy_number=trim($_GET['pn']);
        
        $action_page='select_policy_user_contractors_all_risk_insurance.php?pn='.$policy_number;
	 //fetch
        $returned_json_decoded= fetch_policy_type_specific($type_is,$policy_number,'/client/console/select_policy_user_contractors_all_risk_insurance.php');
        ...
        if($check_is==true)//if check is true
        {
            ...
            $contract_price_multiplier=$message_is['contract_price_multiplier'];
        ...
        else
        {
         ...
         //submit
        if(isset($_POST['contract_price']) && !empty($_POST['contract_price']) )
        {
            $contract_price=trim($_POST['contract_price']);
            ...
            $items_array_is=array('policy_number'=>$policy_number,
                                'contract_price_multiplier'=>$contract_price_multiplier,
            ...
            $details_are=fetch_personal_details(3,$_SESSION['session_key'],$_SESSION['cookie'],'/shopping_kart/checkout_login.php');
             check_out_kart_with_email($array_kart,$email_address,'/client/console/select_policy_user_contractors_all_risk_insurance.php',$details_are['full_names']);
            
           
            header('location: view_user_contractors_all_risk_insurance.php?message=Policy selected&type=1');//
        }
...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
	 <title>Contractors all risk insurance select</title>
    <!-- Favicon-->
...
<body class="theme-deep-orange">
    ...
    <section class="content">
        <div class="container-fluid">
          ...
          <h4>Enter total contract price</h4>
            <input type="number" min="1" class="form-control" name="contract_price" contract_price_multiplier_is="<?php echo $contract_price_multiplier;?>" id="contract_price" placeholder="Contract price"/>
            <br>
           <h4> Premium  <span id="premium_span"></span></h4>
        ...
        <script type="text/javascript" src="../../javascript/contractors_all_risk_insurance_select.js"></script>
