...
if(isset($_GET['message']) && !empty($_GET['message']) && isset($_GET['type']) && !empty($_GET['type']))
{
	$message=$_GET['message'];
	 ...
	 $message='<span id="'.$good_bad_id.'">'.$message.'</span>';
                ...
                //fetch
            $returned_json_decoded= fetch_policy_type(15,'/client/console/select_user_motor_psv_uber_insurance.php');
            ...
            //get privacy items
            $policy_privacy_array=fetch_policy_privacy('15','client/console/select_user_motor_psv_uber_insurance.php');
            ...
            if($check_is==true)//if check is true
            {
                                 ...
                                 $list_items='';
                                  ...
                                  {//start of foreach $message_is as $value
                                        ...
                                        $list_items.='<a href="select_policy_user_motor_psv_uber_insurance.php?pn='.$policy_number.'" title="click to view '.$company_name.' motor insurance " class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br>';
