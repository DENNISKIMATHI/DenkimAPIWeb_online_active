    ...
    <section class="content">
        <div class="container-fluid">
		  ...
		  <div class="row clearfix">
            ...
            <input type="text" id="employee_id_for_use_is" class="form-control"/><br>  
             <h4>Enter employee salary.</h4>
            <input type="number" id="employee_salary_for_use_is" class="form-control"/><br> 
            
            <select  name="list_of_categories" id="list_of_categories" onchange="add_employees_for_wiba_plan_b()" class="form-control">
           ...
           <h4>Select employers liability insurance from the options below;</h4>
             <?php
