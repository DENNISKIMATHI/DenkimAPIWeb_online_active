...
{   
        ...
        //fetch email
        $personal_details_array=fetch_personal_details(3,$_SESSION['session_key'],$_SESSION['cookie'],'/client/console/select_policy_user_performance_bond_insurance.php');
        $email_address=$personal_details_array['email_address'];
        
        $policy_number=trim($_GET['pn']);
        
	 //fetch
        $returned_json_decoded= fetch_policy_type_specific($type_is,$policy_number,'/client/console/select_policy_user_performance_bond_insurance.php');
        ...
        if($check_is==true)//if check is true
        {
            ...
            $w_multiplier=$message_is['w_multiplier'];
        ...
        if(isset($_POST['contract_price']) && !empty($_POST['contract_price']) )
        {
            ...
            $details_are=fetch_personal_details(3,$_SESSION['session_key'],$_SESSION['cookie'],'/shopping_kart/checkout_login.php');
             check_out_kart_with_email($array_kart,$email_address,'/client/console/select_policy_user_performance_bond_insurance.php',$details_are['full_names']);
            
           
            header('location: view_user_performance_bond_insurance.php?message=Policy selected&type=1');//
            //decide what to do
        }
...
<head>
	...
	<title>Performance bond insurance select</title>
    <!-- Favicon-->
    ...
    <section class="content">
        <div class="container-fluid">
		 ...
		 <form action="<?php echo $action_page;?>" method="post">
           <h4>Enter Contract Price</h4>
            <input type="number" min="1"  class="form-control" name="contract_price" contract_price_multiplier_is="<?php echo $contract_price_multiplier;?>" w_multiplier_is="<?php echo $w_multiplier;?>" id="contract_price" placeholder="Contract price"/>
            <br>
        ...
        <script type="text/javascript" src="../../javascript/performance_bond_insurance_select.js"></script>
