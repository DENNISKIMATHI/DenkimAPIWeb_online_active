...
if(isset($_GET['message']) && !empty($_GET['message']) && isset($_GET['type']) && !empty($_GET['type']))
{
	...
	$message='<span id="'.$good_bad_id.'">'.$message.'</span>';
                ...
                //fetch
            $returned_json_decoded= fetch_policy_type(3,'/client/console/select_user_accident_insurance.php');
            ...
            $message_is=$returned_json_decoded["message"];//message
             ...
             //get privacy items
            $policy_privacy_array=fetch_policy_privacy('3','/client/console/select_user_accident_insurance.php');
            ...
            if($check_is==true)//if check is true
            {
                                 ...
                                 $count=$skip;//make count skipped rows
                                  ...
                                  {//start of foreach $message_is as $value
                                        ...
                                        if($is_private==false)
                                        {
                                             //$list_items.='<li><a href="select_policy_user_accident_insurance.php?pn='.$policy_number.'" title="click to view '.$company_name.' accident insurance " class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br><img src="'.$logo_url.'"/><br><br></li>';
                                        $list_items.='<a href="select_policy_user_accident_insurance.php?pn='.$policy_number.'" title="click to view '.$company_name.' accident insurance " class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br>';
