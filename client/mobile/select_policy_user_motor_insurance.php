...
{   
        $type_is=1;//type
         //fetch email
        $personal_details_array=fetch_personal_details(3,$_SESSION['session_key'],$_SESSION['cookie'],'/client/console/select_policy_user_motor_insurance.php');
        $email_address=$personal_details_array['email_address'];
        
        $policy_number=trim($_GET['pn']);
        
        $action_page='select_policy_user_motor_insurance.php?pn='.$policy_number;
	 //fetch
        $returned_json_decoded= fetch_policy_type_specific($type_is,$policy_number,'/client/console/select_policy_user_motor_insurance.php');
        ...
        if($check_is==true)//if check is true
        {
            ...
            $excess_protector_percentage=$message_is['excess_protector_percentage'];
            $political_risk_terrorism_percentage=$message_is['political_risk_terrorism_percentage '];
            $aa_membership=$message_is['aa_membership'];
        ...
        if(isset($_POST['insured_item_value']) && !empty($_POST['insured_item_value']) )
        {
            ...
            $details_are=fetch_personal_details(3,$_SESSION['session_key'],$_SESSION['cookie'],'/shopping_kart/checkout_login.php');
             ...
             check_out_kart_with_email($array_kart,$email_address,'/client/console/select_policy_user_motor_insurance.php',$details_are['full_names']);
...
<head>
 ...
 <title>Motor insurance select</title>
    <!-- Favicon-->
   ...
   <section>
    ...
    <section class="content">
        ...
        <form action="<?php echo $action_page;?>" method="post">
            <h4>Enter the value of your car</h4>
			
			 <?php echo $message;?>
			 
            <input type="number" min="1" name="insured_item_value" premium_percentage_is="<?php echo $premium_percentage;?>" id="insured_item_value" placeholder="Vehicle value" class="form-control"/>
            <br>
          
			
			<h4>Premium 
			<span id="premium_span"></span></h4><br>
                                        ...
                                        <div class="panel panel-warning">
                                            ...
                                            <div id="collapseThree_1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree_1">
                                                <div class="panel-body">
                                                          <div class="switch">
														  <br>
                Excess protector: <label><input class="w3-radio" type="checkbox" excess_protector_percentage_is="<?php echo $excess_protector_percentage;?>" status_is="unchecked" name="excess_protector_percentage_is" id="excess_protector_percentage_is" value="1"><span class="lever"></span></label><span id="excess_protector_percentage_is_span"></span><br><br>
                Political Risk/terrorism: <label><input  type="checkbox" political_risk_terrorism_percentage_is="<?php echo $political_risk_terrorism_percentage;?>" status_is="unchecked"  name="political_risk_terrorism_percentage_is" id="political_risk_terrorism_percentage_is" value="1" > <span class="lever"></span></label><span id="political_risk_terrorism_percentage_is_span"></span><br><br>
                AA Membership/Rescue: <label><input type="checkbox" name="aa_membership_is" value="1" checked ><span class="lever"></span></label><span id="premium_span"><?php echo 'KES. '.number_format($aa_membership) ?></span><br><br>
			</div>
        ...
        <script type="text/javascript" src="../../javascript/motor_insurance_select.js"></script>
