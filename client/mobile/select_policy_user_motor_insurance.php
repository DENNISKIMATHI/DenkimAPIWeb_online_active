...
<body class="theme-orange">
    ...
    <section class="content">
        ...
        <form action="<?php echo $action_page;?>" method="post">
            <h2>Enter the value of your car</h2>
            <input type="number" min="1" name="insured_item_value" premium_percentage_is="<?php echo $premium_percentage;?>" id="insured_item_value" placeholder="Vehicle value"/>
            <br>
            <br>
            ...
            <span id="premium_span"></span>
                ...
                <h2>Additional benefits</h2><br><br>
                    <div class="switch">
                Excess protector: <label><input class="w3-radio" type="checkbox" excess_protector_percentage_is="<?php echo $excess_protector_percentage;?>" status_is="unchecked" name="excess_protector_percentage_is" id="excess_protector_percentage_is" value="1"><span class="lever"></span></label><span id="excess_protector_percentage_is_span"></span><br>
