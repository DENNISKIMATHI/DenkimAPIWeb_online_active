    ...
    <section class="content">
        <div class="container-fluid">
		  ...
		  <div class="row clearfix">
            ...
            <h4>Enter estimated total value of goods carried at any one trip.</h4>
            <input class="form-control" type="number" min="1" name="estimated_carry_on_any_trip" required a_percentage_is="<?php echo $a_percentage;?>" b_percentage_is="<?php echo $b_percentage;?>" id="estimated_carry_on_any_trip" placeholder="Estimated total value of goods carried at any one tripp"/>
            <br>
            <h4>Enter estimated total value of all goods carried annually in all trip.</h4>
            <input class="form-control" type="number" min="1" name="total_annual_estimated_carry_all_trips" required a_percentage_is="<?php echo $a_percentage;?>" b_percentage_is="<?php echo $b_percentage;?>" id="total_annual_estimated_carry_all_trips" placeholder="Estimated total value of all goods carried annually in all trip"/>
            <br>
            
            <h4>Enter geographical area of transit.</h4>
            <textarea name="geographical_area" required placeholder="Geographical area of transit" class="form-control"/></textarea>
            <br>
            <h4>Enter types of goods carried.</h4>
            <textarea name="types_of_goods" required placeholder="Types of goods carried." class="form-control"/></textarea>
            <br>
           
            <select name="mode_of_transport" required class="form-control">
