...
if(isset($_GET['message']) && !empty($_GET['message']) && isset($_GET['type']) && !empty($_GET['type']))
{
	...
	$message='<span id="'.$good_bad_id.'">'.$message.'</span>';
                ...
                //fetch
                $returned_json_decoded= fetch_policy_type(11,'/client/console/select_user_out_patient_medical_insurance.php');
                                     ...
                                     $count=$skip;//make count skipped rows
                                      ...
                                      {//start of foreach $message_is as $value
                                        ...
                                        if($is_private==false)
                                        {
                                            ...
                                            $list_items.='<a href="select_policy_user_out_patient_medical_insurance.php?pn='.$policy_number.'" title="click to view '.$company_name.' out patient insurance "class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br>';
