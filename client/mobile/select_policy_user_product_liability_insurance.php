        ...
        <div class="container-fluid">
		  ...
		  <div class="row clearfix">
		   ...
		   <form action="<?php echo $action_page;?>" method="post">
               <h4>Enter limits of cover (minimum limit <?php echo number_format($minimum)?>).</h4>
            <input class="form-control" type="number" min="<?php echo $minimum;?>" name="limit" premium_percentage_is="<?php echo $premium_percentage;?>" required id="limit" placeholder="Limits of cover."/>
            <br>
            <h4>Types of goods.</h4>
            <textarea class="form-control" name="types_of_goods" required  placeholder="Types of goods"></textarea>
            <br>
