...
{//if(isset($_GET['l']) && is_numeric($_GET['l']) && ( $_GET['s']==0 || is_numeric($_GET['s']) ) && isset($_GET['re']) && !empty($_GET['re'])  )
        ...
        $action_page="wallet_statement.php?l=".$limit."&s=".$skip."&re=".$rows_every;//for form submission
        $full_link="wallet_statement.php?l=".$limit."&s=".$skip."&re=".$rows_every;//for form submission
        $link_without_sort_column_sort_order="wallet_statement.php?l=".$limit."&s=".$skip."&re=".$rows_every;//for headers sorting
        $link_without_limit_skip_rows_every="wallet_statement.php";//for browsing
