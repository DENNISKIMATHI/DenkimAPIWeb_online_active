...
<body class="theme-orange">
    ...
    <section class="content">
        ...
        <form action="<?php echo $action_page;?>" method="post">
           <h2>Enter Contract Price</h2>
            <input type="number" min="1" name="contract_price" contract_price_multiplier_is="<?php echo $contract_price_multiplier;?>" w_multiplier_is="<?php echo $w_multiplier;?>" id="contract_price" placeholder="Contract price"/>
            <br>
            <br>
