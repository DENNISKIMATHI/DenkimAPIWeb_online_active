                                 ...
                                 $list_items='';
                                  ...
                                  {//start of foreach $message_is as $value
                                       $company_name=$value['company_name'];
                                        ...
                                        $list_items.='<li><a href="select_policy_user_product_liability_insurance.php?pn='.$policy_number.'" title="click to view '.$company_name.' motor insurance " class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br></li>';
