...
//fetch
$returned_json_decoded= fetch_policy_type(16,'/policies/wiba_and_employers_insurance.php');
...
if($check_is==true)//if check is true
{
    ...
    //get privacy items
    $policy_privacy_array=fetch_policy_privacy('16','/policies/wiba_and_employers_insurance.php');
                     ...
                     $list_items='';
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            if($is_private==false)
                            {
                                $list_items.='<li><a href="../policies_select/wiba_and_employers_insurance_select.php?pn='.$policy_number.'" title="click to view '.$company_name.' wiba and employers liability insurance "class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a></li><br><br>';
...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
         <title>Wiba and employers liability insurance</title>
    <!-- Favicon-->
                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <h2>Wiba and employers liability insurance : Select from the insurance options below</h2>
                                </div>
                               </div>
                         </div>
                        <div class="body">
