...
//fetch
$returned_json_decoded= fetch_policy_type(2,'/policies/in_patient_medical_insurance.php');
...
if($check_is==true)//if check is true
{
    ...
    //get privacy items
    $policy_privacy_array=fetch_policy_privacy('2','/policies/in_patient_medical_insurance.php');
                     ...
                     $count=$skip;//make count skipped rows
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            if($is_private==false)
                            {
                             ...
                             //$list_items.='<li><a href="../policies_select/in_patient_medical_insurance_select.php?pn='.$policy_number.'" title="click to view '.$company_name.' in patient medical insurance "class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br><img src="'.$logo_url.'"/></li><br><br>';
                             $list_items.='<li><a href="../policies_select/in_patient_medical_insurance_select.php?pn='.$policy_number.'" title="click to view '.$company_name.' in patient medical insurance "class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a></li><br><br>';
                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <h2>  In patient medical insurance : Select from the insurance options below</h2>
                                </div>
                               </div>
                         </div>
                        <div class="body">
