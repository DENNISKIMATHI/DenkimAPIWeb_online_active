...
//fetch
$returned_json_decoded= fetch_policy_type(4,'/policies/contractors_all_risk_insurance.php');
                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <h2>Contractors all risk insurance : Select from the insurance options below</h2>
                                </div>
                               </div>
                         </div>
                        <div class="body">
