...
//fetch
$returned_json_decoded= fetch_policy_type(15,'/policies/motor_psv_uber_insurance.php');
...
if($check_is==true)//if check is true
{
    ...
    //get privacy items
    $policy_privacy_array=fetch_policy_privacy('15','/policies/motor_psv_uber_insurance.php');
                     ...
                     $list_items='';
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            if($is_private==false)
                            {
                                $list_items.='<li><a href="../policies_select/motor_psv_uber_insurance_select.php?pn='.$policy_number.'" title="click to view '.$company_name.' motor psv, uber, taxify, little cab and institutional buses and vans insurance "class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a></li><br><br>';
...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
         <title>Motor psv, uber, taxify, little cab and institutional buses and vans insurance</title>
    <!-- Favicon-->
                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <h2>Motor psv, uber, taxify, little cab and institutional buses and vans insurance : Select from the insurance options below</h2>
                                </div>
                               </div>
                         </div>
                        <div class="body">
