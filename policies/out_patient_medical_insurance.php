...
//fetch
$returned_json_decoded= fetch_policy_type(11,'/policies/out_patient_medical_insurance.php');
...
if($check_is==true)//if check is true
{
    ...
    //get privacy items
    $policy_privacy_array=fetch_policy_privacy('11','/policies/out_patient_medical_insurance.php');
                     ...
                     $count=$skip;//make count skipped rows
                      ...
                      {//start of foreach $message_is as $value
                            ...
                            if($is_private==false)
                            {
                                //$list_items.='<li><a href="../policies_select/out_patient_medical_insurance_select.php?pn='.$policy_number.'" title="click to view '.$company_name.' out patient insurance "class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a><br><br><img src="'.$logo_url.'"/></li><br><br>';
                             $list_items.='<li><a href="../policies_select/out_patient_medical_insurance_select.php?pn='.$policy_number.'" title="click to view '.$company_name.' out patient insurance "class="btn btn-block btn-lg btn-warning waves-effect">'.strtoupper($company_name).'</a></li><br><br>';
...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
         <title>Out patient medical insurance</title>
    <!-- Favicon-->
                        ...
                        <div class="header">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <h2> Out patient medical insurance : Select from the insurance options below</h2>
                                </div>
                               </div>
                         </div>
                        <div class="body">
